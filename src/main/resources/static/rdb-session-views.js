...
(function () {
    ...
    window.dbagentInitRdbSessionViews = function (options) {
        ...
        // 못 주는 엔진은 이 문구가 그대로 나가면 "트리로 보여준다 / 맨 위 Holder를 처리하면" 이
        // 화면과 어긋나고, 바로 아래 서버가 준 blocker_note("holder 를 알려주지 않습니다")와도
        // 정면으로 모순된다. 그래서 화면이 자기 문구를 넘길 수 있게 열어 둔다 - 여기에 db_type
        // 분기를 넣지 않는 것은 탭 구성을 마크업이 정하는 것과 같은 이유다.
